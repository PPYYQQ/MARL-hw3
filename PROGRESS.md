...
- 正式训练：已启动单 seed tmux 会话 `hw3_full_20260531_seed1`，按 `mappo/happo` × `3s5z`/`8m_vs_9m` 顺序运行 full tuned config；当前已同步 `MAPPO` + `3s5z` 完整 20000000-step 结果，并同步 `HAPPO` + `3s5z` 到 19520000-step checkpoint。
