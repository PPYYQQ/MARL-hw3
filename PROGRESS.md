...
- 正式训练：已启动单 seed tmux 会话 `hw3_full_20260531_seed1`，按 `mappo/happo` × `3s5z`/`8m_vs_9m` 顺序运行 full tuned config；当前已同步 `MAPPO` + `3s5z` 和 `HAPPO` + `3s5z` 完整 20000000-step 结果；`MAPPO` + `8m_vs_9m` full run latest synced checkpoint 为 2880000 steps。
...
- [x] 同步 `MAPPO` + `8m_vs_9m` 2880000-step 早期 full checkpoint。
- [ ] 完成正式训练或记录无法完成的资源原因。
