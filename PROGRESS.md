...
| 2026-05-31 | `47fd362` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 480000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `01cf4dc` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 800000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `2485b36` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 1040000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `7e41ba5` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 1360000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `e9422e8` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 1600000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `562aef9` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 1920000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `bff53da` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 2160000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `d16c961` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 2480000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `ae9fd75` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 2640000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `d4462b4` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 2960000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `f33469a` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 3280000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
| 2026-05-31 | `ba41670` | 同步 `HAPPO` + `8m_vs_9m` recovery run 到 3680000 steps，更新汇总、曲线、报告、PDF 和校验清单 | `sync_harl_results.py`、`plot_win_rate.py`、`build_report_pdf.sh`、`validate_submission.py` |
...
| 2026-06-14 | `70c148c` | 重构英文最终报告，删除 `Environment and Reproducibility` 章节，详细补充 MAPPO/HAPPO 算法设计、HARL 实现设计和实验设计 | `package_overleaf_report.sh`、`validate_submission.py`、`git push` |
| 2026-06-14 | `7a351fe` | 在英文最终报告中新增环境安装过程，并加入对安装、指标、算法稳定性和 recovery run 的观察与思考 | `package_overleaf_report.sh`、`validate_submission.py`、`git push` |
