...
- `results/raw/full/`：正式训练同步进来的阶段性 `progress.txt`；当前包含 `MAPPO` + `3s5z` 到 1200000-step 的 15 个 evaluation。
...
- 正式训练：当前完成 1000-step smoke test 和 4 组 10000-step pilot；单 seed full 训练已在 `hw3_full_20260531_seed1` 中运行，并同步到 `MAPPO` + `3s5z` 的 1200000-step checkpoint。
