...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 2480000 environment steps with final eval reward 16.2173 and final eval win rate 0.500; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 2480000 environment steps, eval reward 16.2173, eval win rate 0.500.
- Command:
