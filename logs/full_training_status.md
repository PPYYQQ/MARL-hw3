...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 4880000 environment steps with final eval reward 18.0655 and final eval win rate 0.775; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 4880000 environment steps, eval reward 18.0655, eval win rate 0.775.
- Command:
