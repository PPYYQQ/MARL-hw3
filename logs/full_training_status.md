...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 3680000 environment steps with final eval reward 17.9086 and final eval win rate 0.75; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 3680000 environment steps, eval reward 17.9086, eval win rate 0.75.
- Command:
