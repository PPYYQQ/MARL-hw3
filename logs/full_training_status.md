...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 2160000 environment steps with final eval reward 17.0511 and final eval win rate 0.625; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 2160000 environment steps, eval reward 17.0511, eval win rate 0.625.
- Command:
