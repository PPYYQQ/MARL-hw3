...
- Latest synced checkpoint: `MAPPO` + `3s5z` reached 1200000 environment steps with eval reward 18.7562 and eval win rate 0.75; best synced win rate is 0.8 at 1040000 steps.
