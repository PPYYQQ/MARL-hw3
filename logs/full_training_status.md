...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 2960000 environment steps with final eval reward 17.2180 and final eval win rate 0.675; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 2960000 environment steps, eval reward 17.2180, eval win rate 0.675.
- Command:
