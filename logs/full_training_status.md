...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 800000 environment steps with final eval reward 13.6532 and final eval win rate 0.275; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 800000 environment steps, eval reward 13.6532, eval win rate 0.275.
- Command:
