...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 3840000 environment steps with final eval reward 16.3014 and final eval win rate 0.55; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 3840000 environment steps, eval reward 16.3014, eval win rate 0.55.
- Command:
