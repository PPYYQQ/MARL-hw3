...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 3280000 environment steps with final eval reward 17.7460 and final eval win rate 0.725; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 3280000 environment steps, eval reward 17.7460, eval win rate 0.725.
- Command:
