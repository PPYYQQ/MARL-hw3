...
- Latest synced checkpoint: `MAPPO` + `3s5z` reached 2080000 environment steps with eval reward 19.3924 and eval win rate 0.9; best synced win rate is 0.9 at 2080000 steps.
