...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 4560000 environment steps with final eval reward 18.3151 and final eval win rate 0.8; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 4560000 environment steps, eval reward 18.3151, eval win rate 0.8.
- Command:
