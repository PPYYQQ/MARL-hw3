...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 480000 environment steps with final eval reward 12.1561 and final eval win rate 0.125; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 480000 environment steps, eval reward 12.1561, eval win rate 0.125.
- Command:
