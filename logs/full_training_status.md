...
- Latest recovery checkpoint: `HAPPO` + `8m_vs_9m` recovery run reached 1600000 environment steps with final eval reward 15.6194 and final eval win rate 0.450; this run is still in progress and is tracked separately from the original stale run.
...
- Latest synced recovery checkpoint: 1600000 environment steps, eval reward 15.6194, eval win rate 0.450.
- Command:
