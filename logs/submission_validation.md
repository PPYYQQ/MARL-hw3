...
| `report/main.pdf` | OK | 885321 bytes; 3 pages |
| `results/processed/progress_summary.csv` | OK | 548 data rows |
...
| `results/raw/full` | WARN | 2 progress.txt files; full training not complete |
